...
{
    [TestClass]
    public class KataCodewarTest
    {
        [TestMethod]
        public void ValidateNegativeValue()
        {
            Assert.AreEqual(Kata.Kata.DescendingOrderCodewar(-25), 0);
        }

        [TestMethod]
        public void ValidateZeroValue()
        {
            Assert.AreEqual(0, Kata.Kata.DescendingOrderCodewar(0));
        }
        ...
        public void ValidateValue1()
        {
            int value = 1;
            int expectedValue = 1;
            Assert.AreEqual(Kata.Kata.DescendingOrderCodewar(value), expectedValue);
        }
